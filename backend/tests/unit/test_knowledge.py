...
class TestKnowledgeService:
    ...
    @pytest.mark.asyncio
    async def test_add_and_lookup_by_category(self, service: InMemoryKnowledgeService) -> None:
    ...
    @pytest.mark.asyncio
    async def test_lookup_by_finding(self, service: InMemoryKnowledgeService) -> None:
    ...
    @pytest.mark.asyncio
    async def test_search_by_content(self, service: InMemoryKnowledgeService) -> None:
